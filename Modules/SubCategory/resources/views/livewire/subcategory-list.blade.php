<div>
    <div class="page-header">
        ...
        <p style="color:#666; margin-top:0.4rem; margin-bottom:0.75rem; font-size:0.9rem;">
            Explore available subcategories
        </p>
        <input
            type="text"
    ...
    @else
        <div class="empty-state">
            <p style="font-size:1.2rem; color:#666;">No subcategories found for "{{ $search }}".</p>
        </div>
    @endif

<div >
            
              <a href="{{ route('categories.index', $category) }}" class="back-button">
        ← Back to Categories
    </a>
</div>
