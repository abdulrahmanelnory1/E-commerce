    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="page-header">
                ...
                <p style="color:#666; margin-top:0.4rem; margin-bottom:0; font-size:0.9rem;">Browse our collection of categories</p>
            </div>
            ...
            @else
                <div class="empty-state">
                    <p style="font-size:1.2rem; color:#666;">No categories found.</p>
                </div>
            @endif
